...
| R-064 | CWC, HWC | * | * | RETIRED 2026-09-22 — no single-feed special (SL = family constant, I/O = 2.3125, HD = 4 for any stated feed count) | CHK CWC!C33:C34 / HWC!C37:C38 (2026-09-22): no `C14=1` arm; John 2026-09-22 | — | — | YAML entries kept `deprecated: true`; feeds ABSENT now resolves I/O and HD HIGH too (John 2026-09-24, RP-004 A3 — the sheet's `C14=""` gate is on Dave's fix list) |
